...
**用你自己的语言提问即可。** skill 正文是中文，因为来源多为中文原著或中译本；这只是文本放在哪里的问题，用英语、日语、韩语、法语提问，就用那种语言得到回答。为什么只有一棵源树，见[多语言支持](#多语言支持)。
