...
| Skill | 内容 | 主要来源 |
|---|---|---|
| `sw-chinese-opera-banqiang` | 舞台层戏曲的板腔体一格（京剧／豫剧／越剧与小戏；杂剧／传奇／昆曲是曲牌体，另开 skill，待建）：陆军的唱词三好（性格定韵与重点句定韵、宽韵险韵与同字韵、句式忌一律七字十字、唱段落在重场戏）与六组范例，加一张媒介边界表，说明通用 skill 哪几层能用在戏曲上。缺口明写：各剧种的板式与韵辙表、行当与程式、剧本体例、大师全本，列为计划而非已有 | 陆军；计划：翁偶虹、范钧宏、李渔《闲情偶寄》 |
...
**规则。** 一个门类会不会让模型写出结构、格式、语言规则都不同的东西？会，就单开 skill；只是题材或风格不同，就放进现有 skill 当案例。题材（谍战、古装、家庭）和导演风格不算；除非像小津那样有完整剧本集，否则是案例不是方法。

**戏曲是两套写法，不是一个门类。** 对编剧有意义的分轴是声腔体系，不是剧种。**曲牌体**（元杂剧、明清传奇、昆曲）是填词：每支曲牌有固定字数、句式、平仄，词填进去；杂剧四折一楔子、一人主唱，传奇按出。**板腔体**（京剧、豫剧、越剧、秦腔、评剧、沪剧）是上下句：七字或十字的上下句为基础，靠板式变化撑起唱段，行当分唱，单位是场。结构单位和唱词写法都不同，所以是两个 skill。同一体系内的剧种，差别只在查哪张韵表（京剧十三辙 vs 豫剧中州韵）、哪张板式表，同一方法配不同的表，是 reference 附录，不是 skill；中国三百多个剧种，一剧种一 skill 就是我们在语言那件事上否掉的同一种组合爆炸。两个不干净的边：**粤剧**梆黄是板腔、小曲是填词，而且用粤语，九声与韵部和普通话完全不同，要不要单开看模型的粤语音韵够不够用来查表，材料进来再测；**川剧**五腔并用，高腔属曲牌体，会同时出现在两个 skill 的附录里。

**现在有什么。** `sw-chinese-opera-banqiang` 装了陆军的唱词方法（选韵、句式、布局）与范例——他的例子全是越剧、沪剧和小戏，都是板腔体——加一张媒介边界表，说明通用 skill 哪几层能用在戏曲上、哪几层不能。这部分是从 `sw-dialogue` 搬出来的，一个通用 skill 的触发条件里不该挂着「写戏曲唱词」。skill 里明写了它还没覆盖什么，description 只承诺已有的部分。

**计划补什么，按顺序。** 板腔体：跨剧种的结构方法（一人一事、场、行当、程式、唱念做打），来源范钧宏、翁偶虹、汪曾祺、张庚／郭汉城、王安祈、罗怀臻；剧种附录做成表格（京剧十三辙与西皮二黄板式字句，刘吉典；豫剧中州韵与板式）；戏曲剧本体例；大师语料按契诃夫的做法全本逐场拆（《锁麟囊》《曹操与杨修》《朝阳沟》《白蛇传》《沙家浜》、越剧《红楼梦》、魏明伦）。然后是 `sw-chinese-opera-qupai`：填词法、宫调与套数、一人主唱的结构，来源李渔《闲情偶寄》词曲部、吴梅、王季烈，全本《窦娥冤》《西厢记》《牡丹亭》《桃花扇》《长生殿》。之后是中国话剧一脉在契诃夫之外的东西：曹禺的封闭空间高压结构、老舍《茶馆》的人像展览式无主线结构。音乐剧排最后，歌承担叙事是一套真正不同的规则，现有 32 本书里没有。

**不做什么。** 竖屏短剧与 AI 漫剧，它们的逻辑是投放不是剧作学。按题材拆、按导演拆、按剧种拆的 skill。
